...
An implementation of the grouping function documented in the https://docs.python.org/3/library/itertools.html[itertools] Python module.
...
[source,sh]
----
➜ git clone git@github.com:jwillikers/chunkify.git
----
